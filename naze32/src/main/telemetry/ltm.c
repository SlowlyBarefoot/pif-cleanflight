...
void configureLtmTelemetryPort(void)
{
    ...
    ltmPort = openSerialPort(portConfig->identifier, FUNCTION_TELEMETRY_LTM, NULL, baudRates[baudRateIndex], TELEMETRY_LTM_INITIAL_PORT_MODE, SERIAL_NOT_INVERTED, 10);
    if (!ltmPort)
        return;
    ltmEnabled = true;
}
